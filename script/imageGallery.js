        ...
        const images = [
            {
                ...
                details: 'Fabric Type: Raw Silk<br>Embroidery: Sitara Tilla Work<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
            ...
            },
            {
                ...
                details: 'Fabric Type: Velvet<br>Embroidery: Handcrafted<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
                code: 'Product Code: DDC001'
            },
            {
                src: './assets/images/image8.jpg',
                title: 'Elegant Evening Cushion',
                details: 'Fabric Type: Satin<br>Embroidery: Machine Embroidery<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
                code: 'Product Code: EEC001'
            },
            {
                src: './assets/images/image9.jpg',
                title: 'Rustic Charm Cushion',
                details: 'Fabric Type: Raw Silk<br>Embroidery: Patch Work<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
                code: 'Product Code: RCC001'
            },
            {
                src: './assets/images/image10.jpg',
                title: 'Autumn Aura Cushion',
                details: 'Fabric Type: Raw Silk<br>Embroidery: Floral Design<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
            ...
            },
            {
                ...
                details: 'Fabric Type: Raw Silk<br>Embroidery: Abstract Design<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
                code: 'Product Code: MMC001'
            },
            {
                src: './assets/images/image13.jpg',
                title: 'Bohemian Bliss Cushion',
                details: 'Fabric Type: Raw Silk<br>Embroidery: Boho Style<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
                code: 'Product Code: BBC001'
            },
            {
                src: './assets/images/image14.jpg',
                title: 'Classic Comfort Cushion',
                details: 'Fabric Type: Raw Silk<br>Embroidery: Knitted Pattern<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
