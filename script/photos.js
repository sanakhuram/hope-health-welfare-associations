export function initPhotoGallery() {
    ...
    const photos = [
        { src: './assets/images/1.jpg', caption: '2018 Annual convocation and students marriage' },
        ...
        { src: './assets/images/7.jpg', caption: 'Mrs. Saima Ahad DCO Okara visit our Institute' },
        { src: './assets/images/8.jpg', caption: 'Yearly Marriage Ceremony of students' },
        ...
        { src: './assets/images/13.jpg', caption: 'Concordia college professor delivered self grooming lecture' },
        { src: './assets/images/14.jpg', caption: '2023 Pakistan independce Day Celebrations' },
        { src: './assets/images/15.jpg', caption: 'Prize Distribution' },
        { src: './assets/images/16.jpg', caption: 'Celebration of Independence day' },
        { src: './assets/images/17.jpg', caption: 'Ranal vocational institute student visit' },
