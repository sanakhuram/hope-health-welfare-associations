    ...
    const images = [
      {
        ...
        details:
          'Fabric Type: Raw Silk<br>Embroidery: Sitara Tilla Work<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
      ...
      },
      {
        ...
        details:
          'Fabric Type: Velvet<br>Embroidery: Handcrafted<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
      ...
      },
      {
        ...
        details:
          'Fabric Type: Satin<br>Embroidery: Machine Embroidery<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
      ...
      },
      {
        ...
        details:
          'Fabric Type: Raw Silk<br>Embroidery: Patch Work<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
      ...
      },
      {
        ...
        details:
          'Fabric Type: Raw Silk<br>Embroidery: Floral Design<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
      ...
      },
      {
        ...
        details:
          'Fabric Type: Raw Silk<br>Embroidery: Classic Embroidery<br>Price: 1700 PKR (Price per piece)',
      ...
      },
      {
        ...
        details:
          'Fabric Type: Raw Silk<br>Embroidery: Abstract Design<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
      ...
      },
      {
        ...
        details:
          'Fabric Type: Raw Silk<br>Embroidery: Boho Style<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
      ...
      },
      {
        ...
        details:
          'Fabric Type: Raw Silk<br>Embroidery: Knitted Pattern<br><span class="price">Price: 1500 PKR (Price per piece)</span>',
